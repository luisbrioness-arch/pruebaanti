...
final class VentaRepository
{
    ...
    public function crear(array $datos): int
    {
        $stmt = Database::connection()->prepare(
            'INSERT INTO ventas (numero_venta_tuves, cliente_nombre, comuna, plan_id, vendedor_id, estado)
             VALUES (:numero_venta_tuves, :cliente_nombre, :comuna, :plan_id, :vendedor_id, :estado)'
        );
        $stmt->execute($datos);
