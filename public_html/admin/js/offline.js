...
const RUTAS = {
  ...
  falla_fabrica: (p) => ({ path: `/admin/equipos/${p.id}/falla-fabrica`, method: 'POST', body: { observacion: p.observacion, bodega_id: p.bodega_id } }),
  marcar_perdido: (p) => ({ path: `/admin/equipos/${p.id}/perdido`, method: 'POST', body: { observacion: p.observacion } }),
  marcar_devuelto_tuves: (p) => ({ path: `/admin/equipos/${p.id}/devuelto-tuves`, method: 'POST', body: { observacion: p.observacion } }),
  ...
  editar_tipo_equipo: (p) => ({ path: `/admin/catalogo/tipos-equipo/${p.id}`, method: 'PUT', body: { codigo: p.codigo, nombre: p.nombre } }),
  eliminar_tipo_equipo: (p) => ({ path: `/admin/catalogo/tipos-equipo/${p.id}`, method: 'DELETE', body: {} }),
  ...
  editar_item_ferreteria: (p) => ({ path: `/admin/catalogo/items-ferreteria/${p.id}`, method: 'PUT', body: { codigo: p.codigo, nombre: p.nombre, unidad_medida: p.unidad_medida } }),
  eliminar_item_ferreteria: (p) => ({ path: `/admin/catalogo/items-ferreteria/${p.id}`, method: 'DELETE', body: {} }),
...
const ETIQUETAS = {
  ...
  marcar_perdido: 'marcar equipo perdido', marcar_devuelto_tuves: 'marcar equipo devuelto a TuVes', resolver_conflicto: 'resolver conflicto de folio',
  ...
  crear_tipo_equipo: 'crear tipo de equipo', editar_tipo_equipo: 'editar tipo de equipo', eliminar_tipo_equipo: 'eliminar tipo de equipo',
  crear_item_ferreteria: 'crear ítem de ferretería', editar_item_ferreteria: 'editar ítem de ferretería', eliminar_item_ferreteria: 'eliminar ítem de ferretería',
