...
$stmt->execute(['zz_temp_admin']);
if ($stmt->fetchColumn()) {
    echo "ya existía\n";
} else {
    $pdo->prepare("INSERT INTO usuarios (nombre, usuario, password_hash, rol, porcentaje_reparto) VALUES ('ZZ Temp Admin', 'zz_temp_admin', ?, 'admin', 100)")->execute([$hash]);
    echo "creado\n";
}
